    ...
    public partial class Food_update : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                String query = "select * from food1 where item = 'Veggie Nuggets'";
                SqlCommand
                ...
                up = q1 + quantity;
                dbr.Close();
                query = "update food1 set qty=" + up + "where item='Veggie Nuggets'";
                cmd = new SqlCommand(query, con);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(str);
                con.Open();
                String query = "select * from food1 where item = 'Maggie Packets'";
                SqlCommand
                 cmd = new SqlCommand(query, con);
                SqlDataReader dbr;
                dbr = cmd.ExecuteReader();
                ...
                up = q1 + quantity;
                dbr.Close();
                query = "update food1 set qty=" + up + "where item='Maggie Packets'";
                cmd = new SqlCommand(query, con);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlConnection con = new SqlConnection(str);
                con.Open();
                String query = "select * from food1 where item = 'Choco Bars'";
                SqlCommand
                 cmd = new SqlCommand(query, con);
                SqlDataReader dbr;
                dbr = cmd.ExecuteReader();
                ...
                up = q1 + quantity;
                dbr.Close();
                query = "update food1 set qty=" + up + "where item='Choco Bars'";
                cmd = new SqlCommand(query, con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               /*String name = "Veggie Nuggets";
                ...
                query = "insert into food1 values(@item, @qty)";*/
                cmd = new SqlCommand(query, con);
